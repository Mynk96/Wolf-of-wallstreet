...
<html >
  ...
  <div class="form">
    ...
    <ul id="rules" type="square">
      <li>Each participant will be given a Wolf of Wallstreet login, password and a portfolio of Rs 20 lakhs.</li>
      ...
      <li>Any decision taken by the organizers will be final.</li>
    </ul>
