  ...
  <div class="form">
    <div id="stockcontent">
      <?php if(isset($compname)){ ?>
        ...
        <center>
          <h1>1 year Graph</h1>
          <img src="images/companies/<?php echo $compid; ?>-1.png" style="max-width:100%" /><br/>
          <h1>6 months Graph</h1>
          <img src="images/companies/<?php echo $compid; ?>-2.png" style="max-width:100%" /><br/><br/>
          <h1>Balance Sheet</h1>
          <img src="images/companies/<?php echo $compid;?>-3.png" style="max-width:100%" /><br/>
          <h1>CashFlow</h1>
            <img src="images/companies/<?php echo $compid; ?>-4.png" style="max-width:100%" /><br/><br/>
          <h1>Profit and Loss</h1>
          <img src="images/companies/<?php echo $compid; ?>-5.png" style="max-width:100%" /><br/>
          <!--<img src="images/companies/<?php echo $compid; ?>-6.png" style="max-width:100%" /><br/>-->
        </center>
